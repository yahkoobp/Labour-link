...
const PeopleCard = (props) => {
  ...
  return (
        ...
        <div className='flex flex-col items-center justify-center  gap-2 p-4 border border-gray-200 bg-white rounded-md'>
        ...
        <h2 className='font-heading text-sm'>{user_data.firstname} {user_data.lastname}</h2>
        ...
        <div className='flex gap-1 bg-gray-100 px-2 items-center justify-center rounded-md'>
            ...
            <h2 className='font-semibold text-[12px] text-gray-900'>Perinthalmanna</h2>
            </div>
