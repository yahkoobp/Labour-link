...
export const kerala_cities = [
  ...
  export const jobs = [
    ...
    "Waste Picker",
    "Cashew Nut Processing Worker",
    "Spice Farm Worker",
    "Palm Tree Climber",
    "Basket Weaver",
    "Cement Industry Worker",
    "Stone Sculptor",
    "Tobacco Plantation Worker",
    "Bamboo Harvester",
    "Mat Weaver",
    "Charcoal Maker",
    "Vegetable Vendor",
    "Aqua Culture Worker",
    "Brick Maker",
    "Fertilizer Industry Worker",
    "Palm Leaf Artist",
    "Salt Pan Worker",
    "Textile Dyeing Worker",
    "Tapioca Farm Worker",
    "Handloom Operator",
    "Jewelry Artisan",
    "Beedi Rolling Worker",
    "Salt Farmer",
    "Nursery Worker",
    "Ice Cream Vendor",
    "Wood Carver",
    "Handloom Technician",
    "Rubber Processing Worker",
    "Rice Mill Worker",
    "Tobacco Processing Worker",
    "Bamboo Craftsperson",
    "Carpet Weaver",
    "Cashew Nut Picker",
    "Coconut Fiber Worker",
    "Coconut Oil Extractor",
    "Cotton Picker",
    "Cotton Spinning Worker",
    "Fish Processor",
    "Flower Vendor",
    "Fruit Vendor",
    "Incense Stick Maker",
    ...
    "Cashew Nut Sheller",
    "Chalk Maker",
    "Coconut Shell Craftsperson",
    "Coffee Bean Picker",
    "Cotton Ginning Worker",
    "Fish Feed Maker",
    "Flower Arranger",
    "Fruit Packer",
    "Honey Beekeeper",
    ...
    "Wood Turner",
    "Areca Nut Peeler",
    "Ayurvedic Medicine Processor",
    "Bamboo Mat Weaver",
    "Banana Plantation Worker",
    "Betel Nut Picker",
    "Cane Furniture Polisher",
    "Cashew Nut Grader",
    "Chilli Powder Maker",
    "Coconut Wood Carver",
    "Coffee Roaster",
